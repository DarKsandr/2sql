...
if (
    ((XRegExp =
        ...
        (function (e) {
            ...
            function t(e, t, n) {
                ...
                return (e.xregexp = { captureNames: t, isNative: !!n }), e;
            }
            function n(e) {
            ...
            function r(e, r, i) {
                ...
                return (
                    i && (a = p.replace.call(a, RegExp("[" + i + "]+", "g"), "")),
                ...
                try {
                    for (; l--; )
                        if (((a = m[l]), !(("all" !== a.scope && a.scope !== n) || (a.trigger && !a.trigger.call(r))) && ((a.pattern.lastIndex = t), (i = d.exec.call(a.pattern, e)), i && i.index === t))) {
                            s = { output: a.handler.call(r, i, n), match: i };
                            break;
                        }
                } catch (o) {
                    throw o;
            ...
            var c,
                ...
                p = { exec: RegExp.prototype.exec, test: RegExp.prototype.test, match: String.prototype.match, replace: String.prototype.replace, split: String.prototype.split },
                d = {},
                x = {},
                m = [],
                v = "default",
            ...
            return (
                (c = function (n, i) {
                    ...
                    for (
                        n = p.replace.call(n, /^\(\?([\w$]+)\)/, function (e, t) {
                        ...
                        (a = s(n, f, g, h)),
                            a
                                ? (u.push(a.output), (f += a.match[0].length || 1))
                                : ((l = p.exec.call(y[g], n.slice(f))), l ? (u.push(l[0]), (f += l[0].length)) : ((o = n.charAt(f)), "[" === o ? (g = b) : "]" === o && (g = v), u.push(o), ++f));
                    return t(RegExp(u.join(""), p.replace.call(i, /[^gimy]+/g, "")), h.hasNamedCapture ? h.captureNames : null);
                }),
                (g = {
                    on: function (e, t, n) {
                        (n = n || {}), e && m.push({ pattern: r(e, "g" + (H ? "y" : "")), handler: t, scope: n.scope || v, trigger: n.trigger || null }), n.customFlags && (T = p.replace.call(T + n.customFlags, E, ""));
                    },
                    off: function () {
                ...
                (c.replace = function (t, n, i, a) {
                    var l,
                        ...
                        o = n;
                    return (
                        s ? (a === e && n.global && (a = "all"), (o = r(n, "all" === a ? "g" : "", "all" === a ? "" : "g"))) : "all" === a && (o = RegExp(c.escape(n + ""), "g")),
                    ...
                    if ((this.global || (s = this.lastIndex), (r = p.exec.apply(this, arguments)))) {
                        if (
                            (!S &&
                                r.length > 1 &&
                                i(r, "") > -1 &&
                                ((l = RegExp(this.source, p.replace.call(n(this), "g", ""))),
                ...
                (d.replace = function (e, t) {
                    var n,
                        ...
                        o = c.isRegExp(e);
                    return (
                        o ? (e.xregexp && (n = e.xregexp.captureNames), e.global || (s = e.lastIndex)) : (e += ""),
                        a(t, "function")
                            ? (r = p.replace.call(this + "", e, function () {
                                  var r,
                                      i = arguments;
                                  if (n) for (i[0] = new String(i[0]), r = 0; n.length > r; ++r) n[r] && (i[0][n[r]] = i[r + 1]);
    ...
    var SyntaxHighlighter = (function () {
        ...
        function c(e, t, n) {
            ...
            var r,
                i,
                a = 1 != n ? e.childNodes : [e.parentNode],
                l = { "#": "id", ".": "className" }[t.substr(0, 1)] || "nodeName";
        ...
        function h(e, t, n) {
            n = Math.max(n || 0, 0);
            for (var r = n, i = e.length; i > r; r++) if (e[r] == t) return r;
            return -1;
        }
        function f(e) {
        ...
        function P(e) {
            ...
            if (r > 0) for (var i = 0, l = t.length; l > i; i++) t[i] = t[i].substr(r);
            return t.join("\n");
        }
        function k(e, t) {
        ...
        var B = {
            ...
            config: {
                ...
                strings: {
                    ...
                    aboutDialog:
                        '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>About SyntaxHighlighter</title></head><body style="font-family:Geneva,Arial,Helvetica,sans-serif;background-color:#fff;color:#000;font-size:1em;text-align:center;"><div style="text-align:center;margin-top:1.5em;"><div style="font-size:xx-large;">SyntaxHighlighter</div><div style="font-size:.75em;margin-bottom:3em;"><div>version 3.0.83 (Wed, 16 Apr 2014 03:56:09 GMT)</div><div><a href="http://alexgorbatchev.com/SyntaxHighlighter" target="_blank" style="color:#005896">http://alexgorbatchev.com/SyntaxHighlighter</a></div><div>JavaScript code syntax highlighter.</div><div>Copyright 2004-2013 Alex Gorbatchev.</div></div><div>If you like this script, please <a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=2930402" style="color:#005896">donate</a> to <br/>keep development active!</div></div></body></html>',
                },
            },
            ...
            findElements: function (e, t) {
                ...
                for (var l = 0, s = n.length; s > l; l++) {
                    var o = { target: n[l], params: p(e, E(n[l].className)) };
        ...
        return (
            ...
            (B.HtmlScript = function (e) {
                ...
                function n(e) {
                    ...
                    null != u.left && null != e.left && ((n = L(e.left, u.left)), t(n, e.index), (l = l.concat(n))),
                        null != u.right && null != e.right && ((n = L(e.right, u.right)), t(n, e.index + e[0].lastIndexOf(e.right)), (l = l.concat(n)));
                ...
                if (null != i) {
                    ...
                    return null == r.htmlScript ? (v(B.config.strings.brushNotHtmlScript + e), void 0) : (a.regexList.push({ regex: r.htmlScript.code, func: n }), void 0);
                }
            }),
            ...
            (B.Highlighter.prototype = {
                ...
                findMatches: function (e, t) {
                    var n = [];
                    if (null != e) for (var r = 0, i = e.length; i > r; r++) "object" == typeof e[r] && (n = n.concat(L(t, e[r])));
                ...
                getCodeLinesHtml: function (e, t) {
                    ...
                    for (var n = a(e), r = (this.getParam("pad-line-numbers"), parseInt(this.getParam("first-line"))), e = "", i = this.getParam("brush"), l = 0, s = n.length; s > l; l++) {
                        var o = n[l],
                            ...
                            c = null,
                            g = t ? t[l] : r + l;
                        null != u && ((c = "" + u[0]), (o = o.substr(c.length)), (c = c.replace(" ", B.config.space))),
                            (o = C(o)),
                ...
                getHtml: function (t) {
                    ...
                    return (
                        ...
                        (a =
                            ...
                            e(s.join(" ")) +
                            '">' +
                            (this.getParam("toolbar") ? B.toolbar.getHtml(this) : "") +
                            '<table border="0" cellpadding="0" cellspacing="0">' +
                            this.getTitleHtml(this.getParam("title")) +
                            "<tbody>" +
                            "<tr>" +
                            (gutter ? '<td class="gutter">' + this.getLineNumbersHtml(t) + "</td>" : "") +
                            '<td class="code">' +
                            '<div class="container">' +
                            a +
                            "</div>" +
                ...
                forHtmlScript: function (e) {
                    ...
                    e.eof && (t.end = "(?:(?:" + t.end + ")|$)"),
                        (this.htmlScript = { left: { regex: e.left, css: "script" }, right: { regex: e.right, css: "script" }, code: XRegExp("(?<left>" + e.left.source + ")" + "(?<code>.*?)" + "(?<right>" + t.end + ")", "sgi") });
                },
            }),
            B
        );
