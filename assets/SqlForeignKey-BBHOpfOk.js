import{_ as l,o as r,c as s,a,b as t,d as n,F as o}from"./index-BoRpKmuU.js";const i={};function E(u,e){return r(),s(o,null,[e[0]||(e[0]=a(`<p>Оператор SQL FOREIGN KEY (Внешний ключ) служит для указания в одной таблице на Первичный ключ (оператор <a title="Оператор SQL PRIMARY KEY - примеры использования" href="https://web.archive.org/web/20231208195706/http://2sql.ru/advanced/sql-primary-key/" target="_blank">SQL PRIMARY KEY</a>) в другой.</p><p>Оператор SQL FOREIGN KEY имеет следующий синтаксис:</p><p>Для MySQL:</p><pre class="brush: sql; title: ; notranslate" title="">CREATE TABLE table_1 (
ID_1 int NOT NULL
ID_2 int
PRIMARY KEY (ID_1)
