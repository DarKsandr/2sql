...
</pre><p>В данном коде использовались типы СУБД <strong>MS SQL Server</strong>. В других СУБД названия типов могут отличаться!</p><p>В результате выполнения запроса будет создана таблица с перечисленными полями и их типами.</p><p>Пояснение: Поле HavingRings имеет тип bit, принимающее 2 значения — 1 или 0 (TRUE, FALSE).</p>`,9))}const p=e(a,[["render",r]]);export{p as default};
