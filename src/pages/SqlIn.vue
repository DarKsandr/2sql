...
<template>
  <p>Оператор SQL IN позволяет определить, совпадает ли значение объекта со значением в списке.</p>
  <p>Оператор SQL IN имеет следующий синтаксис:</p>
